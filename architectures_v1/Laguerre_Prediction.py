...
class Laguerre_Prediction:

    def __init__(self, input_shape, dataset,
                 units, order, variant, dt,
    ...
    def build_model(self):
        ...
        model.add(RNN(OrthogonalCell(units = self.units,
                             order = self.order,
    ...
    def fit(self, train_generator, test_generator, scaler,
        ...
        # Getting seeds
        seeds = random.sample(range(0, 20), self.n_seeds)
        print(f"seeds: {seeds}")
